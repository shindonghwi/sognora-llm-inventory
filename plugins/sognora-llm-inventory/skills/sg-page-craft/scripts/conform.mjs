/**
 * conform.mjs — sg-landing-forge의 계기를 이 스킬에서 그대로 쓰기 위한 심(shim).
 *
 * 왜 있나: SKILL.md에 `../sg-landing-forge/scripts/conform.mjs`처럼 상대경로를 적어두면
...
const target = join(here, "..", "..", "sg-landing-forge", "scripts", "conform.mjs");
